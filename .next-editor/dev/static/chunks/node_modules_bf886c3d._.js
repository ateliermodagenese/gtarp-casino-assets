...
var temporal = (config, options)=>{
    const configWithTemporal = (set, get, store)=>{
        store.temporal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createStore"])(options?.wrapTemporal?.(temporalStateCreator(set, get, options)) || temporalStateCreator(set, get, options));
...
//# sourceMappingURL=node_modules_bf886c3d._.js.map