    ...
    <motion.button
      ...
      style={{
        ...
        boxShadow: !disabled && isHovered 
          ? `0 0 20px ${glowColor}, 0 4px 16px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.15)` 
      ...
      {icon && !disabled && (
        <img
          ...
          style={{
            ...
            objectFit: "contain",
            filter: "brightness(1.3) drop-shadow(0 1px 2px rgba(0,0,0,0.3))",
            pointerEvents: "none",
          }}
          draggable={false}
        />
  ...
  const actionButtons = [
    {
      ...
      icon: "/assets/games/blackjack/icon-hit.png",
    },
    {
      label: L.stand,
      ...
      icon: "/assets/games/blackjack/icon-stand.png",
    },
    {
      label: L.double,
      ...
      icon: "/assets/games/blackjack/icon-double.png",
    },
    {
      label: L.split,
      ...
      icon: "/assets/games/blackjack/icon-cards-spread.png",
    },
    {
      label: L.surrender,
